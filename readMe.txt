...
카페인 농도(015(기본15%)) : 0~45%에서 5%단위로 설정 => 위의 선택한 원두의 종류로정해짐
디카페인 농도(000(기본0%)) : 0~45%에서 5%단위로 설정
=> 메뉴에 따라(디카페인커피) 디카페인 농도가 15%가 기본이고 카페인농도가 0%인 경우도 있음
=> 디카페인커피의 경우에만 AI주문으로 받을건데, 고민을 좀 더 해야함(AI에서는 카페인농도만 받는데 디카페인은 그럼주문안받나?)
